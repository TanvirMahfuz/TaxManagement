...
public class UserController {
    ...
    public String userLoginCon(
        ...
        if(Password.equals(RePassword)){
            ...
            if(!home.database.user_mode)
            {
                ...
                nuser.setTaxId(HomeController.current_user);
    ...
    public String submitUserForm(@ModelAttribute User userInput,
        ...
        if(home.database.user_mode)
        {
            ...
            if(firstname.equals("") && lastname.equals(""))
                Name=userService.getUserById(HomeController.current_user).getName();
            else
    ...
    public String deleteLawyer(@ModelAttribute User user){
        ...
        taxFunctionsService.deleteTaxFunctions(user.getId());
        return "PreHome";
    }
