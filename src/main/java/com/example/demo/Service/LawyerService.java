...
public class LawyerService {
    ...
    public Lawyer getLawyerById(int id){return lawyerRepo.findById(id).orElse(null);}
    ...
    public Lawyer updateLawyer(Lawyer updatedLawyer) {
        ...
        if (existingLawyerOptional.isPresent()) {
            ...
            existingUser.setGender(updatedLawyer.getGender());
            existingUser.setPhone(updatedLawyer.getPhone());
            existingUser.setNationality(updatedLawyer.getNationality());
            existingUser.setReligion(updatedLawyer.getReligion());
            existingUser.setDivision(updatedLawyer.getDivision());
            existingUser.setCity(updatedLawyer.getCity());
